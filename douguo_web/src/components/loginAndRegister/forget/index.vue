...
<div>
    ...
    <div class="loginCont">
        <div class="register">
            <div class="regTop">
                <span class="fl" style="margin-left: 30px;">新用户注册</span>
                <span class="fr have">已有账号, <router-link to="/login">直接登录 ></router-link></span>
            </div>
           <div class="reform">
                <reform></reform>
           </div>
...
export default {
  ...
  methods: {
    // 刷新注册页面隐藏首页的头部底部
    houzui () {
      this.hz = this.$route.path || '/forget'
      if (this.hz === '/forget') {
        ...
        .regTop{
            ...
            .have{
                ...
                a{
                    color: #3ea000;
                    &:hover{
                        border-bottom:1px solid #3ea000 ;
                        cursor: pointer;
                    }
                }
            }
